  ...
  return (
    <section className='w-full min-h-screen bg-[#111111] flex flex-col items-center justify-center px-4 lg:px-10 gap-16 py-20 lg:py-32'>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3  w-full gap-8 lg:h-[400px] sm:h-[800px] h-[1200px]">
                <a href="https://divineacademy.co.za/" target="_blank" rel="noopener noreferrer"   className="bg-black rounded-2xl overflow-hidden relative  transition-all duration-300 w-full h-full">
                ...
                <a href="https://mxprinters.vercel.app/" target='_blank' rel="noopener noreferrer"  className="bg-black rounded-2xl overflow-hidden relative">
